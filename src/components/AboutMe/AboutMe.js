...
import avatar_vitaly from '../../images/Vitaly.svg';
        ...
        <div className="about-me__content">
          ...
          {/* <p className="about-me__text">
            ...
            <ul className="about-me__socials">
              <li>
                <a href="https://github.com/Evgeta" target="_blank" className="about-me__social-link" rel="noopener noreferrer">
                  Github
                </a>
              </li>
            </ul>
        </div>
        <img className="about-me__avatar" src={avatar_vitaly} alt="Фотография Виталия" />
      </div>
    </div>
  </section>
  );
